...
// const socket = io('http://idp-etcocloud9.c9users.io:8081')
...
export default {
  ...
  sockets: {
    ...
    */
    ...
    userCreated: function (val) {
      console.log('userCreated = ' + val.login)
    },
    userUpdated: function (val) {
      console.log('userUpdated = ' + val.login)
    }
  },
  components: {
    FileUpload
  ...
  methods: {
    ...
    createUser () {
      ...
      this.$socket.emit('createUser', {rtbfLogin: 'etco'})
    },
    updateUser () {
      console.log('updateUser fired')
      this.$socket.emit('updateUser', {rtbfLogin: 'etco', mainRtbfLocation: 'CHA'})
    },
    */
