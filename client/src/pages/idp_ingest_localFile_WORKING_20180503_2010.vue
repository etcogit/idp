...
-->
  <!-- Le composant d'upload est copié de https://lian-yue.github.io/vue-upload-component -->

  <!-- Cette div sert à "noircir" la page quand on Drag un fichier dans la page. Le texte ne s'affiche que quand on drag un fichier sur la page -->
  ...
  <div class="upload">
    ...
    <div class="example-foorer">
      ...
      -->
        ...
        <!--
        <div class="dropdown-menu">
          <label class="dropdown-item" :for="name">Ajouter des fichiers</label>
          <a class="dropdown-item" href="#" @click="onAddFolader">Ajouter un dossier</a>
...
const { humanStorageSize } = format // Je récupère la méthode "humanStorageSize" dans les "utils" de Quasar stockés dans "format" lors de l'import
...
export default {
  ...
  /*
  computed: {
    formatedFileSize: function (sizeToConvert) {
      const { humanStorageSize } = format
      // return humanStorageSize(this.file.size)
      var toto = humanStorageSize(123456789)
      console.log(toto + ' ' + sizeToConvert)
      return 'toto'
